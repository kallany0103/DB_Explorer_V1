...
def build_main_window_menu(main_window):
    ...
    file_menu.addAction(main_window.import_connections_action)
    file_menu.addAction(main_window.export_connections_action)
    file_menu.addSeparator()
    file_menu.addAction(main_window.preferences_action)
    ...
    edit_menu.addAction(main_window.replace_action)
    edit_menu.addSeparator()
